...
$potensi = query("SELECT * FROM potensi ORDER BY id DESC");

if (isset($_POST["cari"])) {
    $potensi = cariPotensi($_POST["keyword"]);
}
            ...
            <div class="container">
                <div class="row slider-text align-items-center justify-content-center">
                    <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
                        <h1 class="pt-5"><span>Daftar Potensi Desa</span></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <form action="" method="post">
                <div class="form-group row font-weight-bold text-uppercase">
                    <h5 class="col-sm-12">Mencari Potensi Desa</h5>
                ...
                <tbody>
                    <?php foreach ($potensi as $row) : ?>
                        <tr>
                            ...
                            <td><a id="edit" class="edit ml10 " href="edit_potensi.php?id=<?= $row["id"]; ?>" title="edit" ><i class="glyphicon glyphicon-edit"></i></a></td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
                </tbody>
