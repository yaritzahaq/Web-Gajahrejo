...
$kritik = query("SELECT * FROM kritik ORDER BY id DESC");

if (isset($_POST["cari"])) {
    $kritik = cariPembuatKritik($_POST["keyword"]);
}
            ...
            <div class="container">
                <div class="row slider-text align-items-center justify-content-center">
                    <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
                        <h1 class="pt-5"><span>Daftar Kritik dan Saran Masyarakat</span></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <form action="" method="post">
                <div class="form-group row font-weight-bold text-uppercase">
                    <h5 class="col-sm-12">Mencari Kritik dan Saran Masyarakat</h5>
                ...
                <tbody>
                    <?php foreach ($kritik as $row) : ?>
                        <tr>
                            ...
                            <td><a href="hapus.php?id=<?= $row["id"]; ?>&hapus=kritik" onclick="return confirm('Mau dihapus ?')"><i class="fas fa-trash text-danger fa-2x"></i></a></td>
                        </tr>
                        <?php $i++; ?>
                    <?php endforeach; ?>
                </tbody>
