...
$pengurus = query("SELECT * FROM pengurus WHERE id = $id");
...
if (isset($_POST["submit"])) {
    ...
    // query sql
    $query = "UPDATE pengurus SET nama='$nama', tahun='$tahun',nosk='$nosk', jabatan='$jabatan' where id='$id'";
    $hasil=mysqli_query($conn, $query);
    
    header("location: admin.php?halaman=pengurus1");

    //cek apakah data berhasil ditambahkan atau tidak
    if (editPengurus($_POST) > 0) {
        echo "
            <script>
                alert('Berhasil Mengedit Pengurus');
            </script>
        ";
    } else {
        echo "
            <script>
                alert('Gagal Mengedit Pengurus');
            </script>
        ";
    }
}
        ...
        <div class="container">
            <table class="table table-bordered text-center">
                ...
                <div class="form-group row font-weight-bold text-uppercase">
                    ...
                    <div class="col-sm-10">
                        <input value="<?php echo $row['tahun'];?>" type="text" name="tahun">
                    </div>
                </div>
                <div class="form-group row font-weight-bold text-uppercase">
                    <label for="nosk" class="col-sm-2 col-form-label text-black">no.sk</label>
                    <div class="col-sm-10">
                        <input value="<?php echo $row['nosk'];?>" type="text" name="nosk">
                    </div>
                </div>
            <div class="form-group row font-weight-bold text-uppercase">
                    <label for="jabatan" class="col-sm-2 col-form-label text-black">jabatan</label>
                    <div class="col-sm-10">
                        <input value="<?php echo $row['jabatan'];?>" type="text" name="jabatan">
                    </div>
                </div>
                <div class="form-group row font-weight-bold text-uppercase">
