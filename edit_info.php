...
$info = query("SELECT * FROM info WHERE id = $id");
...
if (isset($_POST["submit"])) {
    ...
    // query sql
    $query = "UPDATE info SET judul='$judul', profil='$profil' where id='$id'";
    $hasil=mysqli_query($conn, $query);
    
    header("location: admin.php?halaman=info1");
            ...
            <form action="" method="post" enctype="multipart/form-data">
                <div class="form-group row font-weight-bold text-uppercase">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <textarea class="ckeditor" id="summernote" name="profil" ><?php echo $row['profil'] ?></textarea>
                    </div>
                </div>
