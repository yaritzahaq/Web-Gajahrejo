...
if (isset($_POST["submit"])) {
    ...
    if (tambahNikah($_POST) > 0) {
        echo "
            <script>
                alert('Berhasil pembuatan surat');
                document.location.href = '?page=konfirmasi&konfirmasi=nikah';
            </script>
        ";
    } else {
        echo "
            ...
            <div class="container">
                <div class="row slider-text align-items-center justify-content-center">
                    <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
                        <h1 class="pt-5"><span>Form Pembuatan Surat Belum Menikah</span></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <section class="section">
        <div class="container">
            <div class="row mb-5">
                <div class="col-12 text-center">
                    ...
                    <div class="row justify-content-center">
                        <button type="submit" name="cari" class="btn btn-success btn-lg" onclick="location.href='?page=konfirmasi&konfirmasi=nikah'">Melihat No Bukti</button>
                    </div>
                    <br><br>
                    <hr>
                    <h2>Pembuatan Surat Belum Menikah</h2>
            ...
            <form action="" method="post">
                ...
                <div class="form-group row font-weight-bold text-uppercase">
                    <label for="nik" class="col-sm-2 col-form-label text-black">nik</label>
                    <div class="col-sm-10">
                        <input type="text" class="form-control text-uppercase" name="nik" id="nik" oninvalid="this.setCustomValidity('data tidak boleh kosong')" oninput="setCustomValidity('')" placeholder="nik" required autocomplete="off">
                    </div>
                </div>
                <div class="form-group row font-weight-bold text-uppercase">
