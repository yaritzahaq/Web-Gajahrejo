...
if (isset($_POST["submit"])) {
    ...
    // query sql
    $query = "UPDATE potensi SET nama='$nama', keterangan='$keterangan' where id='$id'";
    $hasil=mysqli_query($conn, $query);
    
    header("location: admin.php?halaman=potensi1");

    //cek apakah data berhasil ditambahkan atau tidak
    if (editPotensi($_POST) > 0) {
        echo "
            <script>
                alert('Berhasil Mengedit Potensi');
            </script>
        ";
    } else {
        echo "
            <script>
                alert('Gagal Mengedit Potensi');
            </script>
        ";
    }
}
            ...
            <table class="table table-bordered text-center">
                ...
                <div class="form-group row font-weight-bold text-uppercase">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-10">
                    <textarea class="ckeditor" id="summernote" name="keterangan" ><?php echo $row['keterangan'] ?></textarea>
                    </div>
                </div>
                <div class="form-group row font-weight-bold text-uppercase">
