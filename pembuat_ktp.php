...
$warga = query("SELECT * FROM warga ORDER BY id DESC");

if (isset($_POST["cari"])) {
    $warga = cariPembuatKtp($_POST["keyword"]);
}
            ...
            <div class="container">
                <div class="row slider-text align-items-center justify-content-center">
                    <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
                        <h1 class="pt-5"><span>Daftar calon pembuat surat (KTP)</span></h1>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            <form action="" method="post">
                <div class="form-group row font-weight-bold text-uppercase">
                    <h5 class="col-sm-12">Mencari data pembuat ktp</h5>
