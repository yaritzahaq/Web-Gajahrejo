...
if (isset($_POST["submit"])) {
    ...
    if (tambahPotensi($_POST) > 0) {
        echo "
            <script>
                alert('Berhasil Membuat Potensi');
            </script>
        ";
    } else {
        echo "
            <script>
                alert('Gagal Membuat Potensi');
            </script>
        ";
    }
}
...
<body>
            ...
            <div class="container">
                <div class="row slider-text align-items-center justify-content-center">
                    <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
                        <h1 class="pt-5"><span>Form Pembuatan Potensi Desa</span></h1>
                    </div>
                </div>
            </div>
        </div>
    ...
    <script>
        $('#summernote').summernote({
            placeholder: 'Tuliskan Keterangan Potensi',
            tabsize: 2,
            height: 100
        });
    </script>
